...
if ($sesion->activa()) {
    ...
    $htmlMenu = $objMenu->armarMenu($menues) . "<div class='col align-self-end'><a href='Perfil.php'><button class='btn text-light mx-3'>Perfil</button></a><a href='cerrarSesion.php'><button class='btn text-light'>Cerrar Sesi&oacute;n</button></a></div>";
