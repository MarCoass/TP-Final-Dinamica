...
if ($sesion->activa()) {
    ...
    $htmlMenu = $objMenu->armarMenu($menues) . "<div class='col align-self-end'><a href='Perfil.php'><button class='btn text-light mx-3 fs-5'>Perfil</button></a><a href='cerrarSesion.php'><button class='btn text-light fs-5'>Cerrar Sesi&oacute;n</button></a></div>";
