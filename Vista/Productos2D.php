                ...
                <div class="card m-4" style="width: 18rem;" id="formulario">
                        <form id="formulario" name="formulario" method="post" action="cart.php">
                                ...
                                <div class="card-body">
                                        ...
                                        <p class="card-text"><b>Descripci&oacute;n:</b> <?php echo $arrayProductos[$i]->getProdetalle() ?> - Precio: $<?php echo $arrayProductos[$i]->getProprecio() ?> - Stcok Disponible: <?php echo $arrayProductos[$i]->getProcantstock(); ?></p>
