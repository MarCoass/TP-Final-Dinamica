...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <form id="login_from" class="form-signin" name="login_from" method="POST" action="verificarLogin.php">
      <input type="email" id="usuario" class="fadeIn second" name="usuario" placeholder="usuario@gmail.com">
    ...
    <form id="nuevo_usuario" class="form-signin" name="nuevo_usuario" method="POST" action="registrar_usuario.php">
      <input type="email" id="usuario_nuevo" class="fadeIn second" name="usuario_nuevo" placeholder="usuario@gmail.com">
