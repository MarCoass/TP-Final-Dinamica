...
class C_Menurol
{
    ...
    public function menuesByIdRol($idRoles){
        ...
        foreach($idRoles as $idRol){
            $idRolActual = $idRol->getidrol()->getIdrol(); //esto es feo feo ya se
            $param = ['idrol' => $idRolActual]; //Armo el parametro de busqueda, en este caso por idrol
